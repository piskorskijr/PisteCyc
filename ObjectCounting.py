...
while True:
    ...
    #cv2.putText (frame,'Total Detection Count : ' + str(total),(30,125),cv2.FONT_HERSHEY_SIMPLEX,1,(98,189,184),2,cv2.LINE_AA)
    cv2.putText (frame,'Cyclists In Frame: ' + str(cyclist_count),(30,100),cv2.FONT_HERSHEY_SIMPLEX,1,(98,189,184),2,cv2.LINE_AA)
